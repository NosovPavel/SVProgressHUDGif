...
@property (nonatomic, strong) FLAnimatedImageView *indefiniteAnimatedView;
...
@implementation SVProgressHUDGif

+ (SVProgressHUDGif *)sharedView {
    static dispatch_once_t once;
    static SVProgressHUDGif *sharedView;
...
- (instancetype)initWithFrame:(CGRect)frame {
    if ((self = [super initWithFrame:frame])) {
        ...
        self.accessibilityIdentifier = @"SVProgressHUDGif";
        self.accessibilityLabel = @"SVProgressHUDGif";
        ...
        NSURL *url = [bundle URLForResource:@"SVProgressHUDGif" withExtension:@"bundle"];
...
- (FLAnimatedImageView *)indefiniteAnimatedView {
    if (_indefiniteAnimatedView == nil) {
        _indefiniteAnimatedView = [[FLAnimatedImageView alloc] initWithFrame:CGRectZero];
        
        NSString *filePath = [[NSBundle mainBundle] pathForResource:[self imageName] ofType:@"gif"];
        NSData *imageData = [NSData dataWithContentsOfFile:filePath];
        
        FLAnimatedImage *loadingImage = [[FLAnimatedImage alloc] initWithAnimatedGIFData:imageData];
        _indefiniteAnimatedView.animatedImage = loadingImage;
        _indefiniteAnimatedView.frame = CGRectMake(0, 0, loadingImage.size.width, loadingImage.size.height);
